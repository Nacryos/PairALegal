  ...
  return (
    <div className="min-h-screen bg-white relative overflow-hidden">
      ...
      <div className="absolute inset-0 -z-10">
        ...
        <div className="absolute top-[-10%] left-[-5%] w-[70%] h-[60%] rounded-full bg-blue-400/20 blur-[100px]"></div>
        <div className="absolute top-[30%] right-[-5%] w-[50%] h-[60%] rounded-full bg-violet-500/20 blur-[100px]"></div>
        <div className="absolute bottom-[-10%] left-[20%] w-[60%] h-[40%] rounded-full bg-cyan-400/20 blur-[100px]"></div>
      </div>
